...
* Просматривать расписание в разных режимах (день, неделя, месяц). [Детали и критерии приемки](https://github.com/yulya-cloud/Planning-of-the-educational-process-src/issues/2)
* Редактировать информацию о занятиях.
* Удалять занятия из расписания.

### 2.2. Управление заданиями
Программа должна позволять:
* Создавать новые задания (курсовые, домашние, проекты). [Детали и критерии приемки](https://github.com/yulya-cloud/Planning-of-the-educational-process-src/issues/1)
...
* Напоминать о приближении дедлайнов с возможностью выбора интервала (за день, за неделю и т. д.). [Детали и критерии приемки](https://github.com/yulya-cloud/Planning-of-the-educational-process-src/issues/3)
...
Программа должна позволять:
* Искать занятия и задания по ключевым словам. [Детали и критерии приемки](https://github.com/yulya-cloud/Planning-of-the-educational-process-src/issues/4)
